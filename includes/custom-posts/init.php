...
define('CAAG_HQ_RENTAL_CUSTOM_POST_BRANDS_SLUG', 'brands');
define('CAAG_HQ_RENTAL_CUSTOM_POST_LOCATIONS','caag_hq_rental_locs');
define('CAAG_HQ_RENTAL_CUSTOM_POST_LOCATIONS_SLUG','locations');
...
define('CAAG_HQ_RENTAL_CUSTOM_POST_VEHICLE_CLASSES_SLUG', 'vehicles-classes');
...
define('CAAG_HQ_RENTAL_CUSTOM_POST_ADDITIONAL_CHARGES_SLUG', 'additional-charges');

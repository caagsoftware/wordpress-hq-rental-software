...
{
	wp_register_script('caag-rental-iframe-resize-window', plugins_url(CAAG_HQ_RENTAL_PLUGIN_FOLDER.'/assets/js/iframeResizer.contentWindow.min.js?version=3.5.15'));

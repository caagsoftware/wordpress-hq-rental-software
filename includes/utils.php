...
{
    wp_register_style('caag-rental', plugin_dir_url(__FILE__) . '../assets/css/caag_hq_rental.css?version=1.0.12');
...
function caag_hq_rental_scripts()
{
    ...
    wp_register_script('caag-rental-iframe-init', plugin_dir_url(__FILE__) . '../assets/js/caagResize.js?version=1.0.1', array('jquery'));
    //Enqueue
